...
const Skills = () => {
    ...
    return (
        <div className={` ${width>1280?"mt-4":"mt-10"}`}>
            {
                skills  && skills.length > 0 ? <> 
                <h2 className={` font-semibold  uppercase tracking-widest text-[#D0C2A6] ${width>1280?"text-[14px]":"text-2xl"}`}>
                Skills
            </h2>
                    ...
                    <div className='my-2 skill' key={skill.id}>
                        <h2 className={`uppercase   font-[400] skill ${width>1280?"text-[8px]":"text-[18px]"} mb-1`}>
                         ...
                         <div className={`flex  ${width>1280?"gap-1":"gap-3"}`}>
                         {
                            ...
                            <span className={` bg-black rounded-full ${width>1280?"w-[3px] h-[3px]":"w-[9px] h-[9px]"}`} key={i}></span>
                            )
                         } 
                            </div>                    
                    </div>
