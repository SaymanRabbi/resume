        ...
        <div className={`${width>=1280 || width<=480 || width<=768?" my-1":"my-3"}`}>
            ...
            <div  className={`w-full  bg-[#000000] ${width>=1280 || width<=480 || width<=768?"h-[2px] my-1 ":"h-[2px] my-3 "}`}></div>
             ...
             <h2 className={`font-bold text-[#1b3055] employ_tittle ${width>=1280 || width<=480 || width<=768?"text-[8px]":""}`}>
                ...
                <h2 className={`font-bold text-[#1b3055] employ_location ${width>=1280 || width<=480 || width<=768?"text-[8px]":""}`}>
                {
                        employment?.city
                }
                </h2>
             </div>
                <h2 className={` text-gray-600 font-semibold employ_year ${width>=1280 || width<=480 || width<=768?"text-[8px] mb-1":"mb-3"}`}>
               {
                 employment?.startDate || employment?.endDate ?    employment?.startDate + ' - ' + employment?.endDate : null
                        ...
                        <div className=' flex  gap-3 relative' >
                            ...
                            <p className={`employment employ_skill ${width>=1280 || width<=480 || width<=768?"text-[7px]":"ml-5"}`}>
                                {
                                    employment?.summary
                                }
                            </p>
